...
public class IdiotsandwitchSwordItem extends BetterFoxesModElements.ModElement {
	@ObjectHolder("better_foxes:idiotsandwitch_sword")
	public static final Item block = null;
	public IdiotsandwitchSwordItem(BetterFoxesModElements instance) {
		super(instance, 3);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("u are a idiot"));
			}
		}.setRegistryName("idiotsandwitch_sword"));
	}
